if (typeof(COMMON_JS) === 'undefined') {
    ...
    function post_modify(post_id) {
        if(post_id) document.location.href= cb_url + '/modify/'+post_id;
        else alert('선택된 게시물이 없습니다.');
 ...
 //    });
    ...
    function imgUrlChange(brd_id,limit){
        var src="";
        $.ajax({
            url: cb_url + '/postact/img_url_change/'+brd_id+'/'+limit,
            type: 'POST',
            data: {
                brd_id: brd_id,
                limit : limit,
