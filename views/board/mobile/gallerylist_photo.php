...
<?php 
$segment_arr=explode("_",$this->uri->segment(2,'photo_1'));
    ...
    <nav>
        ...
        ?>
                <li>
                    ...
                    <a rel="example_group" href="<?php echo element(0,element('pln_url', $result)); ?>" title="<?php echo html_escape(element('title', $result)); ?>"><img   src="<?php echo html_escape(element(0,element('pln_url', $result))); ?>" alt="<?php echo 'photo_'.$i ?>" title="<?php echo 'photo_'.$i ?>"  class="" onerror="imgUrlChangeTry(this)" onerror="imgUrlChangeTry(this)" data-urltype="pln_url" data-url="/img_url_header.php?url=<?php echo urlencode(element(0,element('pln_url', $result)))?>&filename=<?php echo 'photo_'.$i ?>"></a>
                </li>
            <?php 
            $i++;
            } 
