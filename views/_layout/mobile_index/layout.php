...
<script type="text/javascript" src="<?php echo base_url('assets/js/jssor.slider-22.1.8.mini.js'); ?>"></script>
...
<!-- 헤더영역 -->
    ...
    if (element('menu', $layout)) {
        ...
        foreach (element(0, $menu) as $mkey => $mval) {            
            ...
            if(element($men_id, $menu) && !strpos($mval['men_link'],'community')){

                $submenuhtml='';
                echo '<section class="submenu_01" id="menu_'.$mkey.'" style="display:none;">
                    <h4>서브메뉴 영역</h4>
                    <nav>
                        <ul>';
