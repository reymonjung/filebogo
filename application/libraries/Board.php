...
class Board extends CI_Controller
{
    ...
    public function latest($config)
    {
        ...
        $view['view']['css'] = element('css', $config);
        $view['view']['sectionId'] = element('sectionId', $config);
        $view['view']['href_url'] = element('href_url', $config);        
        $view['view']['latest_limit'] = $limit;
        $view['view']['brd_id'] = $brd_id;
        ...
        if ($latest && is_array($latest)) {
            foreach ($latest as $key => $value) {
                ...
                $view['view']['latest'][$key]['display_datetime'] = display_datetime(element('post_datetime', $value), 'user','Y.m.d');
